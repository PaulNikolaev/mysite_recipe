...
import apps_django.recipe.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='images/steps/default.jpg', null=True, upload_to=apps_django.recipe.models.cooking_step_upload_to, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=('png', 'jpg', 'webp', 'jpeg', 'gif'))], verbose_name='Изображение этапа')),
